...
class RemindersControllerTest < ActionController::TestCase
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post :create, reminder: { date: @reminder.date, description: @reminder.description, remind_me: @reminder.remind_me, title: @reminder.title }
    end
  ...
  test "should update reminder" do
    patch :update, id: @reminder, reminder: { date: @reminder.date, description: @reminder.description, remind_me: @reminder.remind_me, title: @reminder.title }
    assert_redirected_to reminder_path(assigns(:reminder))
  end
